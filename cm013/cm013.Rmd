...
1. Axes and title
1. Legend and use of colours to differentiate multiple groups from each other
1. Appropriate use of graph type (bar, violin plot, scatterplot, or ridge plot etc.), does it show the information you want to convey?
1. 
1.
...
- <<How to measure motivation? German workers don't work the most on average compared to the other EU nations. The graph lacks information, how many people were sampled, where is the standard deviation?>>
...
- <<Very weak because the y-axis is inverted and there is actually an incresae >>
...
1. Remove background, remove redundant labels
1. Remove borders
1. Reduce colors, remove special effects
1. Remove bolding 
1. Lighten labels, lighten lines or remove lines, direct labels 
